...
class UserFeedAndRepliesViewState
  ...
  void _integrateNewNotes() {
    ...
    ref
        ...
        .integrateRootAndReplyNotes(notesToIntegrate.newRootAndReplyNotes);

    // delte new notes in FeedNew
    newNotesP.newRootAndReplyNotes.clear();
        ...
        if (mainFeedStateP.newRootAndReplyNotes.isNotEmpty)
          Container(
            ...
            child: newPostsAvailable(
                name: "${mainFeedStateP.newRootAndReplyNotes.length} new posts",
                onPressed: () {
                  _integrateNewNotes();
                }),
          ),
