...
abstract class NostrBandPeople implements _i1.SerializableModel {
  NostrBandPeople._({required this.profiles});

  factory NostrBandPeople({required List<_i2.NostrBandProfiles> profiles}) =
      _NostrBandPeopleImpl;
